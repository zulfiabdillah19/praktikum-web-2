                    ...
                    <form id="contactForm" action="proses_pesanan.php" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" name="total_harga" id="total_harga" type="text"
                                placeholder="1000000 " data-sb-validations="required" />
                            <div class="invalid-feedback" data-sb-feedback="total_harga:required">Total Harga is
                                required.</div>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="qty">QTY</label>
                            <input class="form-control" name="qty" id="qty" type="text" placeholder="2"
                                data-sb-validations="required" />
                        ...
                        <div class="mb-3">
                            ...
                            <div class="invalid-feedback" data-sb-feedback="pemesan:required">Nama Produk</div>
                        </div>
                        <div class="mb-3">
